...
public class Informations {
    ...
    public static TableView<Monitor> monitorTable(){
        ...
        columnModelo.setCellValueFactory(data ->{
            if(data.getValue() != null)
                ...
                return new SimpleStringProperty(data.getValue().getModelo());
        ...
        tableV.setItems(DMonitor.obterLista());
        return tableV;
     ...
     * @return tableview contains all data monitors
     * */
    public static TableView<Monitor> oneMonitor(String str){
        ...
        tableV.getColumns().addAll(columnTipo,columnIdentificacao,columnLocalizacao,columnFornecedor,columnObservacao,columnStatus);
        tableV.setEditable(false);
        tableV.setItems(DMonitor.obterIdentificacao(str));
        return tableV;

    }


    public static void attTable(){
      monitorTable().setItems(DMonitor.obterLista());
